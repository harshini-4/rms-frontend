...
document.getElementById("viewOrdersButton").addEventListener("click", () => {
    fetch("https://rms-backend-7cao.onrender.com/order/fetch-all-orders")
...
function viewOrderDetails(orderId) {
    fetch(`https://rms-backend-7cao.onrender.com/order/fetch-order-details/${orderId}`)
        .then(response => response.json())
        .then(details => {
...
document.getElementById("viewRevenueButton").addEventListener("click", () => {
    fetch("https://rms-backend-7cao.onrender.com/order/daily-revenue")
        .then(response => response.json())
        .then(data => {
